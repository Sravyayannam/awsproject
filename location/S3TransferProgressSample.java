...
public class S3TransferProgressSample {
    ...
    private static long Oregonbucketsize = 0;
    private static long northcaliforniasize = 0;
    private static long singaporesize = 0;
    private static long tokyosize = 0;
    private static long sydneysize = 0;
       ...
       // String regions[] = {"US_WEST_2","US_WEST_1","AP_SOUTHEAST_1","AP_NORTHEAST_1","AP_SOUTHEAST_2"};
        ...
        for (Bucket bucket : buckets) {
                ...
                bucketName= bucket.getName();
                    ...
                    //try {
                        //System.out.println("IDCs " + bucketName);
                        ...
                        do {
                            ...
                            for (S3ObjectSummary objectSummary : 
                            	objectListing.getObjectSummaries()) {
                                 ...
                                 {
                            		 //Oregonbucketsize = size;
                            		 Oregonbucketsize = 51200;
                            		 
                                 }
                            	 else if(bucketName.equals("projectidc2"))
                            	 {
                            		 northcaliforniasize = 51200;
                            	 }
